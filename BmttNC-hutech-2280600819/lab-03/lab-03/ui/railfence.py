...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_key.setGeometry(QtCore.QRect(140, 190, 491, 31))
        self.txt_key.setObjectName("txt_key")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(210, 350, 121, 31))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(80, 190, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label.setGeometry(QtCore.QRect(300, 0, 291, 81))
        font = QtGui.QFont()
        ...
        self.btn_decrypt.setGeometry(QtCore.QRect(500, 350, 91, 31))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(20, 260, 121, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_cipher.setGeometry(QtCore.QRect(140, 250, 491, 71))
        self.txt_cipher.setObjectName("txt_cipher")
        self.txt_plaintext = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_plaintext.setGeometry(QtCore.QRect(140, 90, 491, 71))
